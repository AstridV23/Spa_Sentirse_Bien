...
const alertaString = `Te esperamos el ${DatosTurno.formattedDate} a las ${DatosTurno.hora}hs`;
  ...
  return (
        <>
          ...
          <hr />
          <div className="info">
            <p>Tratamiento: {DatosTurno.tipoTratamiento}, servicio: {DatosTurno.servicio}</p>
            <p>fecha: {DatosTurno.formattedDate}, hora: {DatosTurno.hora}hs</p>
        </div>
          <br />
