...
router.post("/service", authRequired, validateSchema(createServiceSchema), createService);
router.put('/service/:serviceId/hours', updateServiceHours);
router.put("/service/:id", authRequired, validateSchema(createServiceSchema), updateService);
