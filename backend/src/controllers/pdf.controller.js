...
export const createPDF = async (req, res) => {
    ...
    try {
        ...
        if (tipo === 'turnos') {
            try {
                console.log('Antes de llamar a getAllBookings');
                const bookingsData = await getAllBookings();
                console.log('Después de llamar a getAllBookings');
                ...
                console.log('Número de reservas:', bookings.length);
                ...
                console.error('Error al generar la tabla de turnos:', error);
                doc.text('Error al generar el informe de turnos', 50, 150);
            }
        } else if (tipo === 'pagos') {
            try {
